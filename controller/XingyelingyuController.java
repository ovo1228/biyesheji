...
public class XingyelingyuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XingyelingyuEntity xingyelingyu,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XingyelingyuEntity xingyelingyu, 
		HttpServletRequest request){
        EntityWrapper<XingyelingyuEntity> ew = new EntityWrapper<XingyelingyuEntity>();
    ...
    public R query(XingyelingyuEntity xingyelingyu){
		...
		return R.ok("查询楼栋名称成功").put("data", xingyelingyuView);
    }
